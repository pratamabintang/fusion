...
Issues and specs for this repository live by default as markdown files in `.scratch/`.
When a remote repository is configured on GitHub, GitHub Issues (via `gh` CLI) can also be used.

## Conventions for Local Markdown Tracker
